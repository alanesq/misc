...
void handlePhoto() {
 ...
 // html header
   ...
   client.write("<title>photo</title>\n");
   client.write("</head> <body>\n");
...
void handleTest() {
 ...
 // log page request including clients IP
   ...
   // html header
     ...
     client.write("<title>test</title>\n");
     client.write("</head> <body>\n");
     client.write("<FORM action='/test' method='post'>\n");       // used by the buttons in the html (action = the web page to send it to
